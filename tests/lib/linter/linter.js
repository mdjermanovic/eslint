...
describe("Linter", () => {
    ...
    describe("when evaluating code with comments to ignore reporting on specific rules on a specific line", () => {
        ...
        describe("eslint-disable-next-line", () => {
            ...
            it("should ignore violations of multiple rules when specified in mixed sinlge line and multi line comments", async () => {
                const code = [
                    "/* eslint-disable-next-line",
                    "no-alert",
...
`;
    ...
    describe("reportUnusedDisable option", () => {
        ...
        it("reports problems for multiple unused eslint-disable comments with mutliple ruleIds", async () => {
            const code = [
    ...
    describe("verify()", () => {
        ...
        describe("ecmaVersion", () => {
            ...
            it("supports ECMAScript version 'latest'", async () => {
                const messages = await linter.verify("let x = 5 ** 7;", {
        ...
        it("should not allow the use of reserved words as variable names in ES > 3", () => {
            ...
            ecmaVersions.forEach(async ecmaVersion => {
                const code = "var enum;";
